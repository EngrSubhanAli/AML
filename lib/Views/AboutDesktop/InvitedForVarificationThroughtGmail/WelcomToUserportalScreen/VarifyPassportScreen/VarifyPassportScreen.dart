...
Uint8List? PassportUploadedFront;

XFile? PassportCameraFront;

class VarifyPassportScreen extends StatefulWidget {
  VarifyPassportScreen({super.key, required this.ShowPassportFront});
  bool ShowPassportFront;
  @override
  State<VarifyPassportScreen> createState() => _VarifyPassportScreenState();
}

class _VarifyPassportScreenState extends State<VarifyPassportScreen> {
  // bool passportScanned = false;

  bool frontPassport = false;
  bool documentScreen = false;
  bool imageGetNotNull = false;
  // CameraDescription ?cameraStatus ;
  int value = 1;
  ...
  void initState() {
    ...
    setState(() {
      imageGetNotNull = widget.ShowPassportFront;
    });
  }
  ...
  _selectFile(bool imageFrom) async {
    ...
    if (fileResult != null) {
      setState(() {
        PassportUploadedFront = fileResult.files.first.bytes!;
      });
      print(".........................................................." +
          PassportUploadedFront.toString());
    }
  }
                                ...
                                ? Center(
                                    child: kButton(
                                      onPressed: () async {
                                        ...
                                        print(PassportCameraFront.toString() +
                                            ".....................................");
                                      },
                                      h: 48,
                                      w: 100,
